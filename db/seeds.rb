...
file13 = URI.open('https://res.cloudinary.com/dogomm21h/image/upload/v1606663142/Whats%20for%20dinner/soupe_de_poulet_%C3%A0_la_citronnelle_frecqb.jpg')
recipe13.photo.attach(io: file13, filename: 'some-image.jpg', content_type: 'image/jpg')
recipe13.save!

recipe14 = Recipe.create!(name: "Moules marinières", difficulty: "facile", price: "bon marché", time: "1 heure", diet: "végétarien", content: "1) Hachez les échalotes.
...
file14 = URI.open('https://res.cloudinary.com/dogomm21h/image/upload/v1606665461/Whats%20for%20dinner/moules_marini%C3%A8res_tusf7e.jpg')
...
file15 = URI.open('https://res.cloudinary.com/dogomm21h/image/upload/v1606666446/Whats%20for%20dinner/paupiettes-wisky_ehnndz.jpg')
...
file16 = URI.open('https://res.cloudinary.com/dogomm21h/image/upload/v1606666999/Whats%20for%20dinner/souris_agneau_miel_thym_hovqgp.jpg')
